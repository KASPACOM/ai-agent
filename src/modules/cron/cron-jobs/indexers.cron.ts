...
export class IndexersCron {
    ...
    constructor(private readonly telegramIndexer: TelegramIndexerService, private readonly twitterIndexer: TwitterIndexerService, private readonly appConfig: AppConfigService) { }
    ...
    protected async runIndexer(indexer: BaseIndexerService) {
        ...
        try {
            ...
            this.logger.error(`${indexer.constructor.name} indexing failed: ${error.message}`);
        }
    }
}
