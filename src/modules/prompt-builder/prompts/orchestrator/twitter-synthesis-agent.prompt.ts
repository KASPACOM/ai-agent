...
export const TWITTER_SYNTHESIS_AGENT_PROMPT: PromptTemplate = {
  name: 'twitter-synthesis-agent',
  description:
...
4. Make the response:
	* User-friendly: use simple language
	* Technical: use technical terms and concepts
